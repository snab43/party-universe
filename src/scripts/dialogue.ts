...
const DIALOGUE_REJECTION: string[] = [
	`I don't know you...`,
	`I don't have a ride!`,
	...
	`I started FriendZone beef so I'm trying to keep it low key.`,
	...
	`I'm in the middle of a FriendZone argument, party later?`,
...
const DIALOGUE_ACCEPTANCE: string[] = [
...
const DIALOGUE_KICKED_OUT: string[] = [
...
const DIALOGUE_TEXT_MESSAGE: string[] = [
	`Hey dude, what's up?`,
...
const DIALOGUE_FRIENDSPACE_POST: string[] = [
	`party time.`,
	`who wants to party?`,
